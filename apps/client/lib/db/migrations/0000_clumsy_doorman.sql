...
CREATE TABLE "teams" (
	...
	"steppay_customer_id" text,
	"steppay_subscription_id" text,
	"steppay_product_code" text,
	"steppay_price_code" text,
	"plan_name" varchar(50),
	"subscription_status" varchar(20),
	CONSTRAINT "teams_steppay_customer_id_unique" UNIQUE("steppay_customer_id"),
	CONSTRAINT "teams_steppay_subscription_id_unique" UNIQUE("steppay_subscription_id")
);
--> statement-breakpoint
CREATE TABLE "users" (
	"id" serial PRIMARY KEY NOT NULL,
